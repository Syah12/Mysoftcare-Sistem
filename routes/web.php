...
Route::middleware([
    ...
    Route::get('/papan-utama', [Admin\DashboardController::class, 'index'])->name('dashboard');
    ...
    Route::group(['prefix' => 'pengurusan-projek'], function () {
        ...
        Route::get('/lihat/{id}', [Admin\ProjectManagementController::class, 'show'])->name('project.show');
    ...
    Route::get('/jadual-bertugas', [Admin\DutyScheduleController::class, 'index'])->name('duty.index');
    ...
    Route::group(['prefix' => 'pelajar-industri'], function () {
    ...
    Route::group(['prefix' => 'agensi'], function () {
        ...
        Route::get('/lihat/{id}', [Admin\AgencyController::class, 'show'])->name('agency.show');
        Route::get('/kemaskini/{id}', [Admin\AgencyController::class, 'edit'])->name('agency.edit');
    });

    Route::group(['prefix' => 'pic-agensi'], function () {
        ...
        Route::get('/lihat/{id}', [Admin\PICAgencyController::class, 'show'])->name('pic.show');
    ...
    Route::group(['prefix' => 'pengguna'], function () {
        ...
        Route::get('/lihat/{id}', [Admin\UserController::class, 'show'])->name('user.show');
    ...
    Route::group(['prefix' => 'jawatan'], function () {
        ...
        Route::get('/lihat/{id}', [Admin\PositionController::class, 'show'])->name('position.show');
    ...
    Route::group(['prefix' => 'universiti'], function () {
        ...
        Route::get('/lihat/{id}', [Admin\UniversityController::class, 'show'])->name('university.show');
        Route::get('/kemaskini/{id}', [Admin\UniversityController::class, 'edit'])->name('university.edit');
    });

    Route::get('/jejak-audit', [Admin\AuditController::class, 'index'])->name('audit.index');
